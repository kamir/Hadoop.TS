...
import hadoopts.analysis.SingleTSToolSum;
 ...
 * @author root
 */
public class TopicRelevanceAnalyser extends javax.swing.JFrame {

    /**
     * Creates new form SequenceFileExplorer
     */
    public TopicRelevanceAnalyser() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("SFExplorer.title")); // NOI18N
        ...
        java.util.ResourceBundle bundle1 = java.util.ResourceBundle.getBundle("tool/Bundle"); // NOI18N
        jTabbedPane1.addTab(bundle1.getString("TopicRelevanceAnalyser.jPanel2.TabConstraints.tabTitle"), jPanel2); // NOI18N
        ...
        jTabbedPane1.addTab(bundle1.getString("TopicRelevanceAnalyser.jPanel1.TabConstraints.tabTitle"), jPanel1); // NOI18N
        ...
        jTabbedPane1.addTab(bundle1.getString("TopicRelevanceAnalyser.jPanel4.TabConstraints.tabTitle"), jPanel4); // NOI18N

        getContentPane().add(jTabbedPane1, java.awt.BorderLayout.CENTER);

        jPanel3.setPreferredSize(new java.awt.Dimension(787, 230));

        jTextField1.setText(bundle1.getString("TopicRelevanceAnalyser.jTextField1.text")); // NOI18N

        jButton3.setText(bundle1.getString("TopicRelevanceAnalyser.jButton3.text")); // NOI18N
        ...
        jButton4.setText(bundle1.getString("TopicRelevanceAnalyser.jButton4.text")); // NOI18N
        ...
        jLabel1.setText(bundle1.getString("TopicRelevanceAnalyser.jLabel1.text")); // NOI18N

        jtLF.setFont(new java.awt.Font("DejaVu Sans", 0, 10)); // NOI18N
        jtLF.setText(bundle1.getString("TopicRelevanceAnalyser.jtLF.text")); // NOI18N

        jlZ.setFont(new java.awt.Font("DejaVu Sans", 1, 13)); // NOI18N
        jlZ.setText(bundle1.getString("TopicRelevanceAnalyser.jlZ.text")); // NOI18N

        jTextField3.setText(bundle1.getString("TopicRelevanceAnalyser.jTextField3.text")); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle1.getString("TopicRelevanceAnalyser.jPanel6.border.title"))); // NOI18N

        jLabel2.setText(bundle1.getString("TopicRelevanceAnalyser.jLabel2.text")); // NOI18N

        jtJAHR.setText(bundle1.getString("TopicRelevanceAnalyser.jtJAHR.text")); // NOI18N

        jLabel3.setText(bundle1.getString("TopicRelevanceAnalyser.jLabel3.text")); // NOI18N

        jtMONAT.setText(bundle1.getString("TopicRelevanceAnalyser.jtMONAT.text")); // NOI18N

        jLabel4.setText(bundle1.getString("TopicRelevanceAnalyser.jLabel4.text")); // NOI18N

        jtTAG.setText(bundle1.getString("TopicRelevanceAnalyser.jtTAG.text")); // NOI18N

        jlL.setText(bundle1.getString("TopicRelevanceAnalyser.jlL.text")); // NOI18N

        jtL.setText(bundle1.getString("TopicRelevanceAnalyser.jtL.text")); // NOI18N

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText(bundle1.getString("TopicRelevanceAnalyser.jRadioButton1.text")); // NOI18N

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText(bundle1.getString("TopicRelevanceAnalyser.jRadioButton2.text")); // NOI18N

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setSelected(true);
        jRadioButton3.setText(bundle1.getString("TopicRelevanceAnalyser.jRadioButton3.text")); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle1.getString("TopicRelevanceAnalyser.jPanel7.border.title"))); // NOI18N

        jcbRAW.setSelected(true);
        jcbRAW.setText(bundle1.getString("TopicRelevanceAnalyser.jcbRAW.text")); // NOI18N

        jcbMW.setSelected(true);
        jcbMW.setText(bundle1.getString("TopicRelevanceAnalyser.jcbMW.text")); // NOI18N

        jcbRATIO.setSelected(true);
        jcbRATIO.setText(bundle1.getString("TopicRelevanceAnalyser.jcbRATIO.text")); // NOI18N

        jCheckBox1.setText(bundle1.getString("TopicRelevanceAnalyser.jCheckBox1.text")); // NOI18N

        jcbWT.setText(bundle1.getString("TopicRelevanceAnalyser.jcbWT.text")); // NOI18N

        jcbDT.setText(bundle1.getString("TopicRelevanceAnalyser.jcbDT.text")); // NOI18N
        ...
        jButton5.setText(bundle1.getString("TopicRelevanceAnalyser.jButton5.text")); // NOI18N
        ...
        jButton6.setText(bundle1.getString("TopicRelevanceAnalyser.jButton6.text")); // NOI18N
        ...
        jLabel5.setText(bundle1.getString("TopicRelevanceAnalyser.jLabel5.text")); // NOI18N

        jButton1.setText(bundle1.getString("TopicRelevanceAnalyser.jButton1.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle1.getString("TopicRelevanceAnalyser.jPanel5.border.title"))); // NOI18N
        ...
        fileMenu.setText(bundle1.getString("TopicRelevanceAnalyser.fileMenu.text")); // NOI18N

        openMenuItem.setMnemonic('o');
        openMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.openMenuItem.text")); // NOI18N
        fileMenu.add(openMenuItem);

        saveMenuItem.setMnemonic('s');
        saveMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.saveMenuItem.text")); // NOI18N
        fileMenu.add(saveMenuItem);

        saveAsMenuItem.setMnemonic('a');
        saveAsMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.saveAsMenuItem.text")); // NOI18N
        fileMenu.add(saveAsMenuItem);

        exitMenuItem.setMnemonic('x');
        exitMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.exitMenuItem.text")); // NOI18N
        ...
        editMenu.setText(bundle1.getString("TopicRelevanceAnalyser.editMenu.text")); // NOI18N

        cutMenuItem.setMnemonic('t');
        cutMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.cutMenuItem.text")); // NOI18N
        editMenu.add(cutMenuItem);

        copyMenuItem.setMnemonic('y');
        copyMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.copyMenuItem.text")); // NOI18N
        editMenu.add(copyMenuItem);

        pasteMenuItem.setMnemonic('p');
        pasteMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.pasteMenuItem.text")); // NOI18N
        editMenu.add(pasteMenuItem);

        deleteMenuItem.setMnemonic('d');
        deleteMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.deleteMenuItem.text")); // NOI18N
        editMenu.add(deleteMenuItem);

        menuBar.add(editMenu);

        helpMenu.setMnemonic('h');
        helpMenu.setText(bundle1.getString("TopicRelevanceAnalyser.helpMenu.text")); // NOI18N

        contentsMenuItem.setMnemonic('c');
        contentsMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.contentsMenuItem.text")); // NOI18N
        helpMenu.add(contentsMenuItem);

        aboutMenuItem.setMnemonic('a');
        aboutMenuItem.setText(bundle1.getString("TopicRelevanceAnalyser.aboutMenuItem.text")); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            System.out.println( "> Ready for Filtering ... " );

            BufferedWriter bw = new BufferedWriter( new FileWriter("./__EXPORT.dat" ));
            
            
            SingleTSToolSum tool = new SingleTSToolSum();
            listContent(  Integer.MAX_VALUE, "", false, bw , tool);
...
//        jTextField1.setText(ff + "_merged");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TopicRelevanceAnalyser().setVisible(true);
            }
        });
    }
    ...
    private void _getMetaData(boolean multi) throws IOException {
        ...
        if (multi) {
            ...
            System.out.println( "> " + z + " Hastables are prepared ... " );
            ...
            System.out.println( "> Hastable is prepared ... " );
    ...
    private void listContent(int j, String part, boolean doStoreIN_RAM, BufferedWriter bw, SingleTSToolSum tool) throws IOException {
        ...
        while (goOn && _i <= LIMIT) {
            ...
            mr.setDescription(_i + " ) " + fn + "_[" + key.toString() + "]");
            String keySHORT = key.toString();
            try {
                keySHORT = key.toString().substring(5);
            }
            catch( Exception ex ) { 
                keySHORT = key.toString();
            }
            mr.setLabel( keySHORT );
...
//            Calendar cal = new GregorianCalendar(2007, 11, 1, 0, 0);
            ...
            try {
                ...
                if ( doStoreIN_RAM ) {
                   ...
                   String result = tool.processReihe(mr2); 
                   bw.write(  mr2.label + " " + result+"\n");
                   bw.flush(); 
                   _i = _i + 1;
                }
            } catch (Exception ex) {
        ...
        System.out.println("--> nr of records     : " + (_i - 1));
...
//    }
    ...
    private int _initLastIndex(File file) throws FileNotFoundException, IOException {
        int max = 0;
...
//                System.out.println(fields[0]);
                ...
                // ANPASSUNG eines externen LISTFILES ... 
                if ( counter == 0 )
                    fields[0] = "1.CN";
                else 
                    fields[0] = "1.A.L";
